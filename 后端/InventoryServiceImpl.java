...
public class InventoryServiceImpl implements InventoryService {
    ...
    @Override
    public List<Map<String, Object>> selectFormation(int id) {
        List<Map<String,Object>> list=inventoryDao.selectByPrimaryKey(id);
        return list;
    }
    ...
    @Override
    public int addFormation() {
        int count=inventoryDao.insertFormation();
        return count;
    }
